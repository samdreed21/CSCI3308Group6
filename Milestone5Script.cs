...
public class disableButton : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (!pressed) // if reset button has not been pressed
        {
            ...
            if (csciToggle.isOn) //if csci buttton is on, disable all buttons not realated to csci courses
            {
                ...
                if (CS1300Toggle.isOn)// If one of the csci classes are pressed, disable the other csci classes
                {
                    ...
                    else if(AverageCourseRatingToggle)
                    {
                        AvgGrade.SetActive(false);
                        NumEnrolled.SetActive(false);
                        PercentA.SetActive(false);
                    ...
                    else if(AverageInstructorRatingToggle)
                    {
                        AvgGrade.SetActive(false);
                        NumEnrolled.SetActive(false);
                        PercentA.SetActive(false);
        ...
        {
            mathToggle.isOn = false;
            csciToggle.isOn = false;
            socyToggle.isOn = false;

            math.SetActive(true);
            csci.SetActive(true);
            socy.SetActive(true);

            CS1300Toggle.isOn = false;
            CS3155Toggle.isOn = false;
            CS3308Toggle.isOn = false;
            CS4229Toggle.isOn = false;
            CS4273Toggle.isOn = false;

            Math1071Toggle.isOn = false;
            Math2300Toggle.isOn = false;
            Math2001Toggle.isOn = false;
            Math3130Toggle.isOn = false;
            Math4430Toggle.isOn = false;

            Soc1016Toggle.isOn = false;
            Soc3024Toggle.isOn = false;
            Soc2034Toggle.isOn = false;
            Soc3011Toggle.isOn = false;
            Soc3041Toggle.isOn = false;
            Soc3041Toggle.isOn = false;
            ...
            AverageInstructorRatingToggle.isOn = false;
            AverageCourseRatingToggle.isOn = false;
            HoursPerWeekToggle.isOn = false;
            PercentBToggle.isOn = false;
            PercentAToggle.isOn = false;
            NumEnrolledToggle.isOn = false;
            AvgGradeToggle.isOn = false;
